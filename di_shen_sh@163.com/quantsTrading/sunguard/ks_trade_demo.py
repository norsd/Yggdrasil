...
def ks_spi_init():
    ...
    global spi
    spi = myTraderSpi(broker_id = "6A89B428",investor_id = "40000006",passwd = "980526",instrument_id = "IF1312")
    user.RegisterSpi(spi)
    user.SubscribePublicTopic(2)
    user.SubscribePrivateTopic(2)
    user.RegisterFront("tcp://210.5.154.195:13153")
    user.Init()
    time.sleep(3)
